...
SpaceHolder is written in [Ruby](https://www.ruby-lang.org/en/) (version 2.4.2) using [Sinatra](http://www.sinatrarb.com/). Development dependencies are managed using the [Bundler](http://bundler.io/) gem.
