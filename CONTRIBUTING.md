...
SpaceHolder is a written in [Ruby](https://www.ruby-lang.org/en/) (version 2.2.3) using [Sinatra](http://www.sinatrarb.com/). Development dependencies are managed using the [Bundler](http://bundler.io/) gem.
