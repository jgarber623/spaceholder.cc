...
SpaceHolder is written in [Ruby](https://www.ruby-lang.org) (version 2.6.6) and uses the [Bundler](https://bundler.io) gem to manage Ruby dependencies.
...
Install Ruby 2.6.6 using a method of your choice (e.g. [rbenv](https://github.com/rbenv/rbenv), [chruby](https://github.com/postmodern/chruby), or [RVM](https://rvm.io)).
